...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
      ...
      <br><br>
	<form name="form_chk" action="">
      <div style="text-align: center;">
	      <label><input type="radio" id="agree" name="checkbox" > 동의함 &nbsp; &nbsp; &nbsp;</label>
	      <!-- <label for="agree"></label> -->
	      <label><input type="radio" id="noAgree" name="checkbox" checked> 동의안함</label>
	      <!-- <label for="noAgree"></label> -->
      </div><br>
